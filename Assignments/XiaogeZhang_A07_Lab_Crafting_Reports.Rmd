...
```{r plot.2018, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Total Nitrogen", fig.align='left', fig.height= 2.5 }

ozone2018 <- filter(epa_data, Year==2018)

ggplot(data=ozone2018) +
...
```{r plot.2019, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Monthly Ozone, 2019", fig.align='left', fig.height= 2.5 }

ozone2019 <- filter(epa_data, Year==2019)

ggplot(data=ozone2019) +
   geom_boxplot(aes(x=factor(Month, levels=1:12, labels=month.abb),y=Ozone)) +
   labs(
...
### Git Repository
https://github.com/alicexiaogezhang
